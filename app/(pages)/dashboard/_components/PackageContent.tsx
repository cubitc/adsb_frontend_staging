...
const PackageContent = () => {
  const [tab, setTab] = useState<"package" | "pin">("package");
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-r from-primary/10 to-crypto-blue/10 border-primary/20">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                You will receive 100 tokens after purchasing the $10 package.
                Token value is usable for buying mining machines after token
                launch.
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Current Packages */}
        <Render>
          <Render.When isTrue={tab === "package"}>
            <Card className="bg-gradient-to-br from-card to-secondary border-border">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-background rounded-lg border border-border ">
                  ...
                  <span className="text-xl font-bold text-crypto-gold">
                    400
                  </span>
                </div>
